...
const DistStockout = () => {
    ...
    useEffect(() => {
      const fetchStockData = async () => {
        try {
          ...
          setStockData(response.data.stockout_bags || response.data); // Update stock data
    ...
    return (
      ...
      <Grid container spacing={2} sx={{ marginTop: 5 }}>
        <Grid item xs={12}>
        <Typography variant="h5" mb={2}>DISTRIBUTOR STOCK OUT</Typography>
