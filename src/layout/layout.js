...
const Layout = ({ sidebarList, pageTitle, childPage }) => {
  ...
  // console.log("sidebardata in layout",sidebarItems);
  ...
  useEffect(() => {
    const savedTheme = localStorage.getItem("theme") || "blueLightTheme";
            ...
            >
              <Toolbar>
                ...
                <Typography variant="h6" sx={{ flexGrow: 1 }}>
                  {pageTitle || "Bariflolabs Cybernetics"}
                </Typography>
                <Box sx={{ flexGrow: 1 }} />
                <IconButton
